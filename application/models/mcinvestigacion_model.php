...
//        echo $id;
        $this->db->select("'' NOMBRE_CONCEPTO,VW.DIRECCION,MUNICIPIO.CODMUNICIPIO COD_MUNICIPIO,MC_MEDIDASCAUTELARES.COD_MEDIDACAUTELAR AS PROCESO,MC_MEDIDASCAUTELARES.COD_RESPUESTAGESTION AS COD_RESPUESTA,VW.RESPUESTA AS RESPUESTA,"
