...
class Liquidaciones_credito extends MY_Controller 
{
	...
	/**
   	* Función que muestra el formulario para consultar los expedientes activos y alos cuales puede acceder el usuario  
   	* @return array $data;
	*/
	{
		try
		{
			if ($this->ion_auth->logged_in()): //verificación de acceso autorizado
				if ($this->ion_auth->is_admin()): //verificación de perfil
					//$this -> template -> set('title', 'Consultar Expedientes');
