...
<div class="caja_negra" id="caja_negra" style="width: 60%; background: #F8F8F8; border-color: black; border: 1px solid grey; margin: auto; overflow: hidden;alignment-adjust: central ;padding: 15px 50px 0">
    ...
    echo form_open_multipart("resolucionprescripcion/Soporte_Expediente", $attributes);
    ?> 
...
<script>
    ...
    $("#push").click(function() {
        ...
        var url5 = "<?php echo base_url("index.php/resolucionprescripcion/VistaPrevia_Documento"); ?>";
