...
//                    echo $data['COD_MEDIDACAUTELAR'];
                    ...
                    switch ($data['COD_RESPUESTAGESTION']) {
                        ...
                        case INICIO_SECRETARIO:
                            ?>
                            <input class="push" type="radio" name="gestion" onclick="secretaria('<?php echo $data['COD_MEDIDACAUTELAR'] ?>', '<?php echo $data['COD_FISCALIZACION'] ?>', '<?php echo $data['CODEMPRESA'] ?>', '<?php echo $data['COD_MEDIDACAUTELAR'] ?>', '<?php echo AUTO1; ?>', '1', '<?php echo DEVOLUCION; ?>', '<?php echo $respuesta="" ?>','<?php echo INICIO_COORDINADOR; ?>')"  />
                        ...
                        case OFICIO_SECRETARIO:
                            ?>
                            <input class="push" type="radio" name="gestion" onclick="secretaria('<?php echo $data['COD_MEDIDACAUTELAR'] ?>', '<?php echo $data['COD_FISCALIZACION'] ?>', '<?php echo $data['CODEMPRESA'] ?>', '<?php echo $data['COD_MEDIDACAUTELAR'] ?>', '<?php echo OFICIO; ?>', '2', '<?php echo OFICIO_DEVOLUCION; ?>', '<?php echo $respuesta="" ?>','<?php echo OFICIO_SUBIR_ARCHIVO;//OFICIO_COORDINADOR; ?>')"  />
                            
                            <?php
                            break;
                        case OFICIO_SECRETARIO2:
                            ?>
                            <input class="push" type="radio" name="gestion" onclick="secretaria('<?php echo $data['COD_MEDIDACAUTELAR'] ?>', '<?php echo $data['COD_FISCALIZACION'] ?>', '<?php echo $data['CODEMPRESA'] ?>', '<?php echo $data['COD_MEDIDACAUTELAR'] ?>', '<?php echo OFICIO2; ?>', '55', '<?php echo OFICIO_DEVOLUCION2; ?>', '<?php echo $respuesta="" ?>','<?php echo OFICIO_SUBIR_ARCHIVO;//OFICIO_COORDINADOR2; ?>')"  />
...
//                    echo $data['COD_RESPUESTAGESTION_BIENES'];
                    switch ($data['COD_RESPUESTAGESTION_BIENES']) {
                        ...
                        case OFICIO_BIENES_INICIO_SECRETARIO:
                            ?>
                            <input class="push" type="radio" name="gestion" onclick="secretaria('<?php echo $data['COD_MEDIDACAUTELAR'] ?>', '<?php echo $data['COD_FISCALIZACION'] ?>', '<?php echo $data['CODEMPRESA'] ?>', '<?php echo $data['COD_MEDIDACAUTELAR'] ?>', '<?php echo OFICIO1; ?>', '5', '<?php echo OFICIO_BIENES_DEVOLUCION; ?>', '<?php echo $respuesta="" ?>','<?php echo OFICIO_BIENES_INICIO_COORDINADOR; ?>')"  />
                        ...
                        case OFICIO_SECRETARIO:
                            ?>
                            <input class="push" type="radio" name="gestion" onclick="secretaria('<?php echo $data['COD_MEDIDACAUTELAR'] ?>', '<?php echo $data['COD_FISCALIZACION'] ?>', '<?php echo $data['CODEMPRESA'] ?>', '<?php echo $data['COD_MEDIDACAUTELAR'] ?>', '<?php echo OFICIO; ?>', '2', '<?php echo OFICIO_DEVOLUCION; ?>', '<?php echo $respuesta="" ?>','<?php echo OFICIO_COORDINADOR; ?>')"  />
