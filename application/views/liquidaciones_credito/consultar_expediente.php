...
* @subpackage Views
* @author     jdussan
* @location   application/views/liquidaciones_credito/consultar_expediente.php
...
<div class="center-form-large" id="cabecera">
	<?php
		...
		echo form_open('liquidaciones_credito/consultarExpediente', $atributos_formulario);
	?>
	<h2 class="text-center">Consultar Expedientes</h2>
	<br><br>
	<table>
		<tr>
			<td>
