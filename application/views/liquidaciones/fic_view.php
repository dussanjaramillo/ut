...
<div class="center-form-xlarge">
      ...
      <tr>
        <td>
          ...
          <?php
            ...
            $atributos_valorInversion = array ('name' => 'valorInversion', 'id' => 'valorInversion', 'type' => 'text', 'class'  => 'input-small',  'value' => '0', 'maxlength' => '19', 'onkeypress' => 'num(this);', 'onblur' => 'num(this);' , 'onkeyup' => 'num(this);');
        ...
        <td>
          ...
          <?php
            ...
            echo '<span class="add-on">$</span>';
            $atributos_gastosFinanciacion = array ('name' => 'gastosFinanciacion', 'id' => 'gastosFinanciacion', 'type' => 'text', 'class'  => 'input-small',  'value' => '0', 'maxlength' => '19', 'onkeypress' => 'num(this);', 'onblur' => 'num(this);' , 'onkeyup' => 'num(this);');
        ...
        <td>
          ...
          <?php
            ...
            echo '<span class="add-on">$</span>';
            $atributos_impuestosLegales = array ('name' => 'impuestosLegales', 'id' => 'impuestosLegales', 'type' => 'text', 'class'  => 'input-small',  'value' => '0', 'maxlength' => '19', 'onkeypress' => 'num(this);', 'onblur' => 'num(this);' , 'onkeyup' => 'num(this);');
      ...
      <tr>
        <td>
          ...
          <?php
            ...
            echo '<span class="add-on">$</span>';
            $atributos_valorLote = array ('name' => 'valorLote', 'id' => 'valorLote', 'type' => 'text', 'class'  => 'input-small',  'value' => '0', 'maxlength' => '19', 'onkeypress' => 'num(this);', 'onblur' => 'num(this);' , 'onkeyup' => 'num(this);');
        ...
        <td>
          ...
          <?php
            ...
            echo '<span class="add-on">$</span>';
            $atributos_indenmizacion = array ('name' => 'indenmizacion', 'id' => 'indenmizacion', 'type' => 'text', 'class'  => 'input-small',  'value' => '0', 'maxlength' => '19', 'onkeypress' => 'num(this);', 'onblur' => 'num(this);' , 'onkeyup' => 'num(this);');
  ...
  <div id="liquidaciones">
            ...
            <div id="cont_costo">
              <table class="table">
                ...
                <tr>
                  ...
                  <td>
                    <?php
                    $atributos_contrato = array ('type' => 'text', 'name' => 'contrato', 'id' => 'contrato', 'value' => set_value('contrato','0'), 'class' => 'input-small', 'required' => 'required', 'maxlength' => '50'    );
                  ...
                  <td>
                    <div class="input-prepend">
                      <?php
                      echo '<span class="add-on">$</span>';
                      $atributos_valor = array ('name' => 'valor', 'id' => 'valor', 'type' => 'text', 'class'  => 'input-small',  'value' => '0', 'maxlength' => '19', 'onkeypress' => 'num(this);', 'onblur' => 'num(this);' , 'onkeyup' => 'num(this);');
              ...
              <div id="contrato_costo" style="display:none">
                  <table id="ContratoCosto" class="table table-striped table-bordered">
            ...
            <div id="cont_obra">
				<table class = "table">
					<tr>
					  ...
					  <td>
						<?php
						$atributos_contratoObra = array ('type' => 'text', 'name' => 'contratoObra', 'id' => 'contratoObra', 'value' => set_value('contratoObra','0'), 'class' => 'input-small', 'required' => 'required', 'maxlength' => '50');
					  ...
					  <td>
						<div class="input-prepend">
						  <?php
						  echo '<span class="add-on">$</span>';
						  $atributos_valorObra = array ('type' => 'text', 'name' => 'valorObra', 'id' => 'valorObra', 'value' => set_value('valorObra','0'), 'class' => 'input-small', 'required' => 'required', 'maxlength' => '19', 'onkeypress' => 'num(this);', 'onblur' => 'num(this);' , 'onkeyup' => 'num(this);');
    ...
    <!-- <div class="row-fluid">
        ...
        ?>
        <a name="transacciones" id="a"></a>
        <table>
            <tr>
                <td width = "200">Número de Transacción: </td>
                <td width = "250"><?php //echo form_input($atributos_buscar); ?></td>
                <td width = "150"><a id = "consultar" class="btn btn-success" href="#transacciones"><i class="fa fa-search"></i>  Buscar</a></td>
            </tr>
        </table>
        <?php
        //echo form_close();
...
<script  type="text/javascript">
  ...
  $("#agregar_contrato_costo").click(function(){
    ...
    var v_contrato = 0;  // Controla ingreso contratos repetidos
    ...
    if (contrato==0 || contrato === ''){
        ...
        // Controla que no se puedan ingresar numero de contratos repetidos a la lista
	var TABLA     = $("#ContratoCosto tbody > tr > td");
	TABLA.each(function(){
            var ID = $(this).find("input[id='" + "contrato_costo" + contrato + "']").val();
            		
            if(ID !== '' && ID == contrato) {
                alert("Contrato Nro. (" + ID + ") ya esta agregado en la lista.");  
                v_contrato = 1;
            } 	
        });
	if (v_contrato == 0) {
	...
	} // Cierre control ingresoe contratos repetidos a la lista
    }
});
...
$("#agregar_contrato_obra").click(function(){
    ...
    var v_contrato = 0; // Controla ingreso contratos repetidos
      ...
      if (contrato==0 || contrato === ''){
        ...
        // Controla que no se puedan ingresar numero de contratos repetidos a la lista
        var TABLA = $("#ContratoObra tbody > tr > td");
        TABLA.each(function(){
            var ID = $(this).find("input[id='" + "contrato_obra" + contrato + "']").val();
        ...
        } // Cierre Control ingreso contratos repetidos
  });
});
